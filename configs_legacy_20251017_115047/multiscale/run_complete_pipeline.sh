...
#
# Options:
#   --dataset PATH            Path to dataset (default: /mnt/d/ign/dataset)
#   --output-base PATH        Base output directory (default: /mnt/d/ign)
...
DATASET="/mnt/d/ign/dataset"
OUTPUT_BASE="/mnt/d/ign"
PHASES="all"
...
phase1_tile_selection() {
    ...
    print_header "Phase 1: Tile Selection from Dataset"
    
    # Analyze dataset
    print_info "Step 1.1: Analyzing dataset..."
...
phase2_preprocessing() {
    ...
    # ASPRS preprocessing only - will be used for all LOD levels
    print_info "Step 2.1: Preprocessing ASPRS tiles (will be used for all LOD patch generation)..."
    run_command "ign-lidar-hd process \
        --config-file \"$PROJECT_ROOT/configs/multiscale/config_asprs_preprocessing.yaml\""
    
    print_success "Phase 2 completed: ASPRS tiles preprocessed and enriched"
}
