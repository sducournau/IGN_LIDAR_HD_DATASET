...
class HeightThresholds:
    ...
    road_height_max: float = 1.5             # Roads (exclude trees/buildings)
    road_height_max_strict: float = 0.5      # Roads strict mode
...
def print_threshold_summary(config: Optional[ThresholdConfig] = None):
    ...
    print("=" * 70)
    print(f"THRESHOLD CONFIGURATION - Mode: {config.mode.upper()}, Strict: {config.strict}")
    print("=" * 70)
...
class ClassificationThresholds:
    ...
    ROAD_HEIGHT_MAX = _config.height.road_height_max  # 1.5
    ROAD_HEIGHT_MIN = _config.height.road_height_min  # -0.5
    ROAD_HEIGHT_MAX_STRICT = _config.height.road_height_max_strict  # 0.5
    ...
    BUILDING_WALL_VERTICALITY_MIN_ASPRS = _config.building.wall_verticality_min_asprs  # 0.65
    BUILDING_WALL_PLANARITY_MIN_ASPRS = _config.building.wall_planarity_min_asprs  # 0.5
    BUILDING_ROOF_HORIZONTALITY_MIN_ASPRS = _config.building.roof_horizontality_min_asprs  # 0.80
    BUILDING_ROOF_PLANARITY_MIN_ASPRS = _config.building.roof_planarity_min_asprs  # 0.65
    
    # Building geometric thresholds - LOD2 mode (stricter)
    BUILDING_WALL_VERTICALITY_MIN_LOD2 = _config.building.wall_verticality_min_lod2  # 0.70
    BUILDING_WALL_PLANARITY_MIN_LOD2 = _config.building.wall_planarity_min_lod2  # 0.55
    BUILDING_ROOF_HORIZONTALITY_MIN_LOD2 = _config.building.roof_horizontality_min_lod2  # 0.85
    ...
    BUILDING_WALL_VERTICALITY_MIN_LOD3 = _config.building.wall_verticality_min_lod3  # 0.75
    BUILDING_WALL_PLANARITY_MIN_LOD3 = _config.building.wall_planarity_min_lod3  # 0.60
    BUILDING_ROOF_HORIZONTALITY_MIN_LOD3 = _config.building.roof_horizontality_min_lod3  # 0.85
    ...
    def get_building_thresholds(cls, mode: str = 'asprs'):
        ...
        return {
            ...
            'wall_verticality_min': getattr(config.building, f'wall_verticality_min_{mode}'),
            'wall_planarity_min': getattr(config.building, f'wall_planarity_min_{mode}'),
            'roof_horizontality_min': getattr(config.building, f'roof_horizontality_min_{mode}'),
            'roof_planarity_min': getattr(config.building, f'roof_planarity_min_{mode}'),
        }
    ...
    def get_transport_thresholds(cls, strict_mode: bool = False):
        ...
        return {
            'road_height_max': config.height.road_height_max_strict if strict_mode else config.height.road_height_max,
            'road_height_min': config.height.road_height_min,
            'road_planarity_min': config.transport.road_planarity_min_strict if strict_mode else config.transport.road_planarity_min,
            ...
            'rail_height_max': config.height.rail_height_max_strict if strict_mode else config.height.rail_height_max,
            'rail_height_min': config.height.rail_height_min,
            'rail_planarity_min': config.transport.rail_planarity_min_strict if strict_mode else config.transport.rail_planarity_min,
