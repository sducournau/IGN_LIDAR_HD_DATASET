...
class SpectralClassificationStrategy(ClassificationStrategy):
    ...
    def classify(self, features: np.ndarray) -> np.ndarray:
        ...
        # Call appropriate method based on available features
        # For now, return unclassified - this should be properly integrated
        logger.warning("SpectralClassificationStrategy: Using stub implementation")
...
class GeometricClassificationStrategy(ClassificationStrategy):
    ...
    def classify(self, features: np.ndarray) -> np.ndarray:
        ...
        # Use apply_all_rules method
        logger.warning("GeometricClassificationStrategy: Using stub implementation")
        return np.zeros(len(features), dtype=np.int32)
...
class ASPRSClassificationStrategy(ClassificationStrategy):
    ...
    def classify(self, features: np.ndarray) -> np.ndarray:
        ...
        # Use apply_all_rules method
        logger.warning("ASPRSClassificationStrategy: Using stub implementation")
        return np.zeros(len(features), dtype=np.int32)
