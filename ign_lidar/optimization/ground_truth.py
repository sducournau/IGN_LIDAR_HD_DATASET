...
class GroundTruthOptimizer:
    ...
    def __init__(
        ...
        Args:
            ...
            gpu_chunk_size: Number of points per GPU chunk (default: 5M)
    ...
    def __repr__(self) -> str:
        ...
        method_info = f"forced to '{self.force_method}'" if self.force_method else "auto-select"
    ...
    def label_points(
        ...
        if self.verbose:
            logger.info(f"Ground truth labeling: {len(points):,} points, {n_polygons:,} polygons")
