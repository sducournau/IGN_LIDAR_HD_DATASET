...
- 📘 **[RGB GPU Guide](/docs/rgb-gpu-guide)** - Complete usage guide
- 🏗️ **[Architecture Overview](/docs/architecture)** - System design with diagrams
- ⚡ **[GPU Guide](/docs/gpu-guide)** - Updated with RGB GPU section
...
- 📘 [RGB GPU Guide](/docs/rgb-gpu-guide)
