#!/bin/bash
# Script to update getting-started.md French translation

FR_FILE="website/i18n/fr/docusaurus-plugin-content-docs/current/guides/getting-started.md"
...
echo "✅ Updated: $FR_FILE"
echo "⚠️  This is a placeholder - full manual translation still needed"
